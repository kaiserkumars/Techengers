...
{
    public class CodeCalenderConfig : SectionConfigBase<RssSchema>
    {
		public override Func<Task<IEnumerable<RssSchema>>> LoadDataAsyncFunc
        {
            get
            {
                ...
                {
                    Url = new Uri("https://codecalender.wordpress.com/feed/")
                };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
					...
					PageTitle = "Code Calender",

                    ListNavigationInfo = NavigationInfo.FromPage("CodeCalenderListPage"),
                    ...
                    {
                        return NavigationInfo.FromPage("CodeCalenderDetailPage", true);
                    }
                };
            }
        }
