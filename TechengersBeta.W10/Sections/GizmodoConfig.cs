...
{
    public class GizmodoConfig : SectionConfigBase<RssSchema>
    {
		public override Func<Task<IEnumerable<RssSchema>>> LoadDataAsyncFunc
        {
            get
            {
                ...
                {
                    Url = new Uri("http://gizmodo.com/rss")
                };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    ListNavigationInfo = NavigationInfo.FromPage("GizmodoListPage"),
                    ...
                    {
                        return NavigationInfo.FromPage("GizmodoDetailPage", true);
                    }
                };
            }
        }
