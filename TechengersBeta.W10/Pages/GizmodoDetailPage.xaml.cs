//---------------------------------------------------------------------------
//
// <copyright file="GizmodoDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class GizmodoDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public GizmodoDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<GizmodoConfig>.Instance);
