//---------------------------------------------------------------------------
//
// <copyright file="DigitDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class DigitDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public DigitDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<DigitConfig>.Instance);
