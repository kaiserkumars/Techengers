//---------------------------------------------------------------------------
//
// <copyright file="TechCrunchDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class TechCrunchDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public TechCrunchDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<TechCrunchConfig>.Instance);
