//---------------------------------------------------------------------------
//
// <copyright file="GeeksForGeeksDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class GeeksForGeeksDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public GeeksForGeeksDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<GeeksForGeeksConfig>.Instance);
