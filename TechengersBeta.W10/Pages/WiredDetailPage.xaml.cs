//---------------------------------------------------------------------------
//
// <copyright file="WiredDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class WiredDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public WiredDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<WiredConfig>.Instance);
