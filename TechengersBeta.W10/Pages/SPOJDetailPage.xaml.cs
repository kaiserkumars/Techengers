//---------------------------------------------------------------------------
//
// <copyright file="SPOJDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class SPOJDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public SPOJDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<SPOJConfig>.Instance);
