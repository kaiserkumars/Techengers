//---------------------------------------------------------------------------
//
// <copyright file="QuoraDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class QuoraDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public QuoraDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<QuoraConfig>.Instance);
