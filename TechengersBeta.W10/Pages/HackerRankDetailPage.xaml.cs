//---------------------------------------------------------------------------
//
// <copyright file="HackerRankDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class HackerRankDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public HackerRankDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<HackerRankConfig>.Instance);
