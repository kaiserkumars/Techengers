//---------------------------------------------------------------------------
//
// <copyright file="StackOverflowDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class StackOverflowDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public StackOverflowDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<StackOverflowConfig>.Instance);
