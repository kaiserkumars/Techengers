//---------------------------------------------------------------------------
//
// <copyright file="Tech2DetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class Tech2DetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public Tech2DetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<Tech2Config>.Instance);
